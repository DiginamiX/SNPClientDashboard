...
export default function Dashboard() {
  ...
  const mockPhotos = [
    ...
    },
    {
      ...
      date: "2023-05-15",
      imageUrl:
        "https://images.unsplash.com/photo-1594381898411-846e7d193883?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&h=300",
      category: "Side",
    },
  ];
  ...
  const mockMessages = [
    {
      ...
      sender: {
        name: "Coach Sarah",
        avatar:
          "https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&auto=format&fit=crop&w=40&h=40",
      },
      preview:
        "Great progress on your weight loss this week! Let's discuss next steps...",
  ...
  const getNextCheckInDate = () => {
    if (
      !isLoadingCheckins &&
      Array.isArray(upcomingCheckins) &&
      upcomingCheckins.length > 0
    ) {
      return format(
        new Date(upcomingCheckins[0]?.date || new Date()),
        "MMMM d, yyyy",
      );
    }
    return "June 15, 2023";
    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <MetricCard
          ...
          icon={
            <i className="ri-bar-chart-line text-custom-blue-500 w-5 h-5" />
          }
          variant="premium"
        />
